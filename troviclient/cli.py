...
@click.pass_context
def cli(ctx, keycloak_url, keycloak_realm, oidc_client_id, oidc_client_secret):
    ctx.ensure_object(dict)
    ctx.obj["troviclient"] = TroviClient(keycloak_url, keycloak_realm, oidc_client_id, oidc_client_secret)
